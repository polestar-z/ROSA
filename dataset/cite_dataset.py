...
class CITEDataset:
    ...
    def load_data(self):
        paper_nodes = pd.read_csv("./CITE/nodes/32/paper_embedding32.csv",encoding='latin-1')         
        keywords_nodes = pd.read_csv("./CITE/nodes/32/keywords_embedding32.csv")  
        author_nodes = pd.read_csv("./CITE/nodes/32/author_embedding32.csv")  
                           
        label_file_path = "./CITE/id+multilabel.csv"
        paper_labels = pd.read_csv(label_file_path)
        substrate_nodes = pd.read_csv("./CITE/nodes/32/substrate_embedding32.csv")                    
        
        paper_author_edges = pd.read_csv("./CITE/edges/author_paper_new.csv")  
        paper_keywords_edges = pd.read_csv("./CITE/edges/paper_keywords.csv")                         
        paper_paper_edges = pd.read_csv("./CITE/edges/paper_paper.csv")                      
        
        paper_substrate_edges = pd.read_csv("./CITE/edges/paper_substrate.csv")
        ...
        author_columns = [f'name_embedding_{i}' for i in range(32)]
        paper_columns = [f'paper_embedding_{i}' for i in range(32)]
