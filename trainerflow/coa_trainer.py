...
from ..sampler import COAsampler
from . import BaseFlow, register_flow
from ..tasks import build_task
from ..utils import extract_embed, EarlyStopping


@register_flow("coatrainer")
class COATrainer(BaseFlow):
    ...
    def __init__(self, args):
        super(COATrainer, self).__init__(args)
    ...
    def preprocess(self):
        if self.args.mini_batch_flag:
            ...
            sampler = COAsampler(self.hg.to('cpu'), self.category, N_SAMPLE_NODES_PER_TYPE, N_SAMPLE_STEPS)
