import dgl
import numpy as np
from ..models.MAGNN_Multi import mp_instance_sampler, mini_mp_instance_sampler
...
class MAGNN_sampler():
    ...
    dataset_name : str
        ...
        Default : 'imdb_node_classification'

    '''
    def __init__(self, g, mask, num_layers, category, metapath_list,
                 num_samples, dataset_name='imdb_node_classification'):
        self.g = g
        self.mask = mask
